<header class="sticky top-0 z-50 w-full border-b border-border bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/80">
    <div class="container flex h-16 items-center justify-between">
        ...
        <nav class="hidden items-center gap-8 md:flex">
            ...
            <a href="{{ route('packages.index') }}" class="text-sm font-medium text-muted-foreground transition-colors hover:text-foreground">Pricing</a>
        ...
        <details class="group md:hidden">
            ...
            <div class="border-t border-border bg-card">
                <nav class="container flex flex-col gap-1 py-4">
                    ...
                    <a href="{{ route('packages.index') }}" class="rounded-lg px-4 py-2.5 text-sm font-medium text-muted-foreground transition-colors hover:bg-muted hover:text-foreground">Pricing</a>
