...
<div class="py-8">
    <div class="mx-auto max-w-4xl sm:px-6 lg:px-8">
        <div class="flex items-center gap-4">
            ...
            <h1 class="text-2xl font-semibold text-slate-900">Edit Testimonial</h1>
        </div>

        <form method="POST" action="{{ route('admin.testimonials.update', $testimonial) }}" class="mt-6 space-y-4 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            @csrf
            @method('PUT')
